...
urlpatterns = [
    ...
    path('almacenista/config-productos/', views.config_productos, name='config_productos'),
    ...
    path('agregar-centro/', views.agregar_centro, name='agregar_centro'),
    path('agregar-programa/', views.agregar_programa, name='agregar_programa'),
